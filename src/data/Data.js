...
export const zBottomMenu = [
    { name: '필독!활용법', link: '/selectissuecategory', icon: <img src={bottomMenuImg1} className='menu-icon' />, activeIcon: <img src={bottomMenuActiveImg1} className='menu-icon' />, allowList: ['/selectissuecategory'] },
    ...
    { name: '대가종목', link: '/themelist', icon: <img src={bottomMenuImg3} className='menu-icon' />, activeIcon: <img src={bottomMenuActiveImg3} className='menu-icon' />, allowList: ['/themelist'] },
    ...
    { name: '구독전용', link: '/noticelist', icon: <img src={bottomMenuImg5} className='menu-icon' />, activeIcon: <img src={bottomMenuActiveImg5} className='menu-icon' />, allowList: ['/noticelist'] }
];
